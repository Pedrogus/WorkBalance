...
-- Pausa das sessões
INSERT INTO BREAK_LOG (ID_BREAK, ID_SESSION, INICIO_PAUSA, FIM_PAUSA, DURACAO, TIPO, COMENTARIO)
VALUES (1, 1, TIMESTAMP '2025-11-14 10:00:00', TIMESTAMP '2025-11-14 10:15:00', 15, 'Café', 'Pausa para café');

INSERT INTO BREAK_LOG (ID_BREAK, ID_SESSION, INICIO_PAUSA, FIM_PAUSA, DURACAO, TIPO, COMENTARIO)
VALUES (2, 2, TIMESTAMP '2025-11-14 15:00:00', TIMESTAMP '2025-11-14 15:10:00', 10, 'Alongamento', 'Pausa rápida para esticar as pernas');

INSERT INTO BREAK_LOG (ID_BREAK, ID_SESSION, INICIO_PAUSA, FIM_PAUSA, DURACAO, TIPO, COMENTARIO)
VALUES (3, 3, TIMESTAMP '2025-11-14 10:30:00', TIMESTAMP '2025-11-14 10:40:00', 10, 'Café', 'Pausa durante análise de processos');

INSERT INTO BREAK_LOG (ID_BREAK, ID_SESSION, INICIO_PAUSA, FIM_PAUSA, DURACAO, TIPO, COMENTARIO)
VALUES (4, 4, TIMESTAMP '2025-11-14 15:30:00', TIMESTAMP '2025-11-14 15:50:00', 20, 'Banheiro', 'Pausa estendida');

INSERT INTO BREAK_LOG (ID_BREAK, ID_SESSION, INICIO_PAUSA, FIM_PAUSA, DURACAO, TIPO, COMENTARIO)
VALUES (5, 5, TIMESTAMP '2025-11-14 10:00:00', TIMESTAMP '2025-11-14 10:12:00', 12, 'Café', 'Pausa curta entre análises');

INSERT INTO BREAK_LOG (ID_BREAK, ID_SESSION, INICIO_PAUSA, FIM_PAUSA, DURACAO, TIPO, COMENTARIO)
VALUES (11, 11, TIMESTAMP '2025-11-14 18:10:00', NULL, NULL, 'Descanso', 'Pausa ainda em andamento');
